                                ...
                                <el-form-item label="分享连接：">
                                    <el-tooltip content="点击访问分享下载页">
                                        <el-link :underline="false"
                                                 @click="$router.push({name:'short',params :{short:share.short}})">
                                            {{ share.short }}
                                        </el-link>
                                    </el-tooltip>
                                </el-form-item>
                    ...
                    <div v-for="file in file_data" :key="file.file_id" class="scrollbar-item">
                        ...
                        >
                            <el-form class="shareinfo">
                                ...
                                <el-form-item label="下载连接：">
                                    <el-button size="small" @click="copyRDownloadUrl(file,$event)">复制下载连接
                                    </el-button>
                                </el-form-item>
...
import {copyRDownloadUrl, diskSize, downloadFile} from "@/utils";
