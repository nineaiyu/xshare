# Generated by Django 4.0.8 on 2022-11-29 03:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=256, verbose_name='备注信息')),
                ('aliyun_drive_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.aliyundrive',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(blank=True, max_length=16, null=True, verbose_name='访问密码')),
                ('description', models.CharField(blank=True, max_length=256, verbose_name='备注信息')),
                ('file_id', models.ManyToManyField(to='api.fileinfo', verbose_name='文件ID')),
                ('owner_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL,
                                               verbose_name='所属用户ID')),
            ],
            options={
